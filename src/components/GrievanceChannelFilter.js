...
function GrievanceChannelFilter({ classes, filters, onChangeFilters, modulesManager }) {
  ...
  return (
    <Grid container className={classes.form}>
      <ControlledField
        module={MODULE_NAME}
        id="grievanceChannelFilter.code"
        field={
      ...
      <ControlledField
        module={MODULE_NAME}
        id="grievanceChannelFilter.name"
        field={
          <Grid item xs={12} sm={6} className={classes.item}>
            <TextInput
              module={MODULE_NAME}
...
export default withModulesManager(withTheme(withStyles(styles)(GrievanceChannelFilter)));
